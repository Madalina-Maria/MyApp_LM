...
const HomeCarousel = () => {
  return (
    <Carousel autoPlay autoFocus interval={1500}>
      <div>
        <img
          className='max-w-6xl object-cover'
      ...
      <div>
        ...
        <br />
        <br />
        <p className='font-mono text-4xl'>Nu ești convins încă? Îți oferim: </p>
      </div>
      <div>
        <img
          className='max-w-5xl object-cover'
      ...
      <div>
        ...
        <br />
        <br />
        <p className='font-mono text-4xl'>Dacă ai cont doar CONECTEAZĂ-TE</p>
      </div>
      <div>
        <img
          className='max-w-4xl object-cover'
